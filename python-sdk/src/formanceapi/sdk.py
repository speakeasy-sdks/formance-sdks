...
class FormanceAPI:
    ...
    def paymentsget_server_info(self) -> operations.PaymentsgetServerInfoResponse:
        ...
        res = operations.PaymentsgetServerInfoResponse(status_code=r.status_code, content_type=content_type)
    ...
    def searchget_server_info(self) -> operations.SearchgetServerInfoResponse:
        ...
        res = operations.SearchgetServerInfoResponse(status_code=r.status_code, content_type=content_type)
