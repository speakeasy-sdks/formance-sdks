...
class Scopes:
    ...
    def add_transient_scope(self, request: operations.AddTransientScopeRequest) -> operations.AddTransientScopeResponse:
        ...
        res = operations.AddTransientScopeResponse(status_code=r.status_code, content_type=content_type)
    ...
    def create_scope(self, request: operations.CreateScopeRequest) -> operations.CreateScopeResponse:
        ...
        res = operations.CreateScopeResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateScopeResponse])
    ...
    def delete_scope(self, request: operations.DeleteScopeRequest) -> operations.DeleteScopeResponse:
        ...
        res = operations.DeleteScopeResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_transient_scope(self, request: operations.DeleteTransientScopeRequest) -> operations.DeleteTransientScopeResponse:
        ...
        res = operations.DeleteTransientScopeResponse(status_code=r.status_code, content_type=content_type)
    ...
    def list_scopes(self) -> operations.ListScopesResponse:
        ...
        res = operations.ListScopesResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListScopesResponse])
    ...
    def read_scope(self, request: operations.ReadScopeRequest) -> operations.ReadScopeResponse:
        ...
        res = operations.ReadScopeResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ReadScopeResponse])
    ...
    def update_scope(self, request: operations.UpdateScopeRequest) -> operations.UpdateScopeResponse:
        ...
        res = operations.UpdateScopeResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateScopeResponse])
