...
class Orchestration:
    ...
    def get_workflow_occurrence(self, request: operations.GetWorkflowOccurrenceRequest) -> operations.GetWorkflowOccurrenceResponse:
        ...
        res = operations.GetWorkflowOccurrenceResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetWorkflowOccurrenceResponse])
    ...
    def orchestrationget_server_info(self) -> operations.OrchestrationgetServerInfoResponse:
        ...
        res = operations.OrchestrationgetServerInfoResponse(status_code=r.status_code, content_type=content_type)
    ...
    def run_workflow(self, request: operations.RunWorkflowRequest) -> operations.RunWorkflowResponse:
        ...
        res = operations.RunWorkflowResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RunWorkflowResponse])
