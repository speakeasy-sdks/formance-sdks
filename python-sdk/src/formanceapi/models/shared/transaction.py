...
class Transaction:
    ...
    post_commit_volumes: Optional[dict[str, dict[str, shared_volume.Volume]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('postCommitVolumes') }})
    pre_commit_volumes: Optional[dict[str, dict[str, shared_volume.Volume]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('preCommitVolumes') }})
