...
class DebitWalletRequest:
    ...
    balances: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('balances'), 'exclude': lambda f: f is None }})
    ...
    pending: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pending'), 'exclude': lambda f: f is None }})
